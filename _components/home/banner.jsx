...
// const test = require('@images/banner1.jpg').default
const Index = () => {
  ...
  return (
    <Slider {...settings}>
      {data?.map((m, index) => (
        <div key={index} className='vh-100 position-relative'>
          ...
          >
            {activeImg === index && (
              <div className='w-75 text-center'>
                ...
                <div className='text-white fs-6 animate__animated animate__fadeInUp mb-5'>
