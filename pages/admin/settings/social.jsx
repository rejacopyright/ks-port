                ...
                <div className='col-12 col-lg-6 mb-3'>
                  ...
                  <div className='input-group input-group-sm input-group-solid border rounded'>
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          quality={10}
                          alt='img'
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/gmail.svg')}
                        />
                      </div>
                    </div>
                    <Field
                    ...
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          ...
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/facebook.svg')}
                        />
                      </div>
                    </div>
                    <Field
                    ...
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          ...
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/twitter.svg')}
                        />
                      </div>
                    </div>
                    <Field
                    ...
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          ...
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/instagram.svg')}
                        />
                      </div>
                    </div>
                    <Field
                    ...
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          ...
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/youtube.svg')}
                        />
                      </div>
                    </div>
                    <Field
                    ...
                    <div className='fs-8 fw-500 input-group-text border-0'>
                      <div className='position-relative same-15px'>
                        <Image
                          ...
                          layout='fill'
                          objectFit='cover'
                          src={require('@images/brands/linkedin.svg')}
                        />
                      </div>
                    </div>
                    <Field
